  ...
  return (
    <>
      ...
      <Box sx={{ textAlign: 'left' }}>
        ...
        <p>
          When registering on our site, rating photos, or testing photos, as
          appropriate, we collect information from you in order to provide and
          improve upon our service. It&apos;s apparent, first of all, that you
          can post images to Photorater.
        </p>
        ...
        <p>
          You may optionally provide us with occupation-related information when
          adding a context label to Business images in which you are the photo
          subject.
        </p>
        ...
        <p>
          ...
          contact you in regards to your Photorater account, and to identify
          your account. Do note that you may unsubcribe from our periodic emails
          at any time, using the link at the bottom of any email you&apos;ve
          received from us.
        </p>

        <p>
          We collect your first name, gender, and birth date or year in order to
          customize your experience, ensure that the correct photos are shown to
          the correct users, and to conduct research.
        </p>

        <p>
          If you optionally choose to label a Business photo of yourself with a
          description of what you do for work, Photorater provides this context
          to targeted users so that they may rate photos more accurately.
        </p>

        <p>
          Any actions performed on Photorater are collected and retained as a
        ...
        <p>
          ...
          option from your
          <Link to="/profile"> profile</Link> page or contact our customer
          service via this <Link to="/contact">contact form</Link> indicating
