    ...
    useEffect(() => {
        async function initBilling(): Promise<void> {
            ...
            try {
                ...
                const details = await digitalGoodsService.getDetails([
                    'coffees'
                ]);
                ...
                {!donated && (
                    <>
                        <Typography variant="subtitle1">
                            If you enjoy playing Pollee, please consider
                            supporting us by buying us a coffee! This will help
                            Pollee to reach its full potential &#128522;
                        </Typography>
                        {!!error && (
                            <Typography
                                color="error"
